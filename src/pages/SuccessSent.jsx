  ...
  return (
    <div className='min-h-[60vh]'>
        <div className='w-[1000px] h-[400px] ml-[14%] mt-[100px] bg-slate-200 p-[50px] rounded-2xl	flex justify-center items-center flex-col'>
            ...
            <h3 className=' text-center capitalize mt-[15px] font-semibold text-gray-700'>We'll try to respond as quickly as possible, it may take 1-2 business days for a response</h3>
            <NavLink to="/contact">
                <button 
                    type="button"
                    width="300px" 
